<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Encuestas/Encuestas.master" CodeBehind="modifgastro.aspx.vb" Inherits="ClinicaGastro.modifgastro" %>
...
<br />
    ...
    <table style="width: 100%;" id="tablaenc7">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownList200" runat="server" AutoPostBack="True" Enabled="False">
...
&nbsp;<asp:TextBox ID="TextBox85" runat="server"  Width="243px"></asp:TextBox>
    ...
    <table style="width:100%;" id="tablaenc35">
        ...
        <tr>
            <td class="textgral" style="width: 80px">Tabaquismo</td>
            <td>
...
<script>
    ...
    <asp:Button ID="Button2" runat="server" Text="Modificar" Width="200px" Visible="false" />

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="Prueba2.aspx.vb" Inherits="ClinicaGastro.Prueba2" %>
...
&nbsp;<asp:TextBox ID="TextBox85" runat="server"  Width="243px"></asp:TextBox>
            ...
            <td style="margin-left: 80px">
                ...
                <table style="width: 100%; height: 192px;" id="tablaenc33">
                    ...
                    <tr>
                        <td style="width: 160px" class="textgral" >Recibiste Transfusiones de Sangre</td>
                        <td>
    ...
    <hr />
        ...
        <table style="width: 100%;" id="tablaenc19" border="1" runat="server">
            ...
            <td style="width: 115px">
                ...
                <asp:DropDownList ID="DropDownList16" runat="server" OnSelectedIndexChanged="DropDownList16_SelectedIndexChanged" AutoPostBack="True" >
...
<script>
    ...
    <asp:Button ID="Button1" runat="server" Text="Guardar" Width="200px" />
    <asp:Button ID="Button2" runat="server" Text="Modificar" Width="200px" />

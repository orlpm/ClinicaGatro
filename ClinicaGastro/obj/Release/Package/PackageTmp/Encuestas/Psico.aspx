<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Encuestas/Encuestas.master" CodeBehind="Psico.aspx.vb" Inherits="ClinicaGastro.Psico" %>
...
<script>
    ...
    function getvalue() {
        var texto1 = document.getElementById('<%=DropDownList1.ClientID()%>').value;
    ...
    <asp:Button ID="Button2" runat="server" Text="Regresar" Width="160px" Visible="False" />
